...
canvas.grid(rowspan=0, column=0)


#Creating labels on GUI window

11 = Label(root, text='Player', font=('Algerian', 25))
12 = Label(root, text='Computer', font=('Algerian', 25))
13 = Label(root, text='Vs', font=('Algerian', 40))
